            ...
            <tr>
              <td align="center" valign="top" style="padding-top: 30px;">
                <a href="https://xeron.io/" target="_blank" style="display: inline-block;">
                  <img src="https://cdn.tokoqu.io/image/8f87694d-5cee-4a63-bae6-88ee66583933.webp" alt="Logo" border="0" width="150" style="display: block; width: 100px; max-width: 100px; min-width: 100px;margin-bottom: 20px;">
                </a>
              </td>
            </tr>
          </table>
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
            ...
            <tr>
              <td align="left" bgcolor="#ffffff" style="padding: 0px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                <p style="margin: 0;">
                  Terima kasih telah mendaftar di Xeron.io. Silakan klik tombol di bawah ini untuk mengonfirmasi alamat email Anda.
                </p>
              </td>
            </tr>
            <!-- end copy -->
                      ...
                      <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td align="center" bgcolor="#3182CE" style="border-radius: 6px;">
                            <a href="{{ route('verify', $user->verification_token) }}" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Confirm Now</a>
                          </td>
                        </tr>
                      </table>
                    </td>
            ...
            <tr>
              <td align="left" bgcolor="#ffffff" style="padding: 0px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                ...
                <p style="margin: 0;"><a href="{{ route('verify', $user->verification_token) }}" target="_blank">Klik disini</a></p>
              </td>
            </tr>
            <!-- end copy -->
            ...
            <tr>
              <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-bottom: 3px solid #d4dadf">
                <p style="margin: 0;">Salam,<br><a href="https://Xeron.io/" target="_blank">Xeron.io</a></p>
              </td>
            </tr>
            <!-- end copy -->
