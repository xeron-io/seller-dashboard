          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
            ...
            <tr>
              <td align="center" bgcolor="#e9ecef" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
                <p style="margin: 0;">
                  Anda ({{ $user->email }}) menerima email ini karena kami menerima permintaan untuk mengatur ulang kata sandi untuk akun Anda. Jika Anda tidak meminta pengaturan ulang kata sandi, Anda dapat mengabaikan email ini.
                </p>
              </td>
            </tr>
            <!-- end permission -->
