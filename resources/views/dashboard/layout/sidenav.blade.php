	...
	<div class="sidebar-wrapper active">
		<div class="sidebar-header position-relative">
			<div class="d-flex justify-content-between align-items-center">
				<div class="logo mt-2">
					<a href="{{ route('dash.overview') }}" class="d-flex">
						<img src="{{ asset('/Assets/logo.png') }}" class="my-auto" alt="Logo" style="width: 20px;height: 20px;"/>
		...
		<div class="sidebar-menu mt-0">
			<ul class="menu">
				...
				<li class="sidebar-item {{ $title == 'Product' ? 'active' : '' }}">
					<a href="{{ route('dash.product') }}" class="sidebar-link">
				...
				<li class="sidebar-item {{ $title == 'Voucher' ? 'active' : '' }}">
					<a href="{{ route('dash.voucher') }}" class="sidebar-link">
				...
				<li class="sidebar-item {{ $title == 'Rekening Bank' ? 'active' : '' }}">
